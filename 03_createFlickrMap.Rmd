...
bk_mapTheme <- function(
  base_size = 11, base_family = "OpenSans-CondensedLight",
  ...
  bg.colour = '#1a0000', colour = colourText_bkbg
    ...
    theme(
      ...
      legend.text = element_text(colour = "#f2f2f2", size = 9, vjust = 1),
      legend.title = element_text(colour = "#f2f2f2", size = 10),
